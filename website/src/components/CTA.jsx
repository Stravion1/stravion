  ...
  return (
    <section ref={sectionRef} className="cta-section">
      <div className="cta-bg">
        <img src="/assets/img-bath2.jpeg" alt="" aria-hidden="true"
      ...
      <div className="container">
        <div className="cta-content">
          ...
          <div className="cta-actions">
            ...
            <a href="mailto:info@stravion.co.uk" className="btn-outline">
              <span>Email Us</span>
            </a>
          </div>
      ...
      {/* Floating WhatsApp */}
      <a href="https://wa.me/447706938064" target="_blank" rel="noopener noreferrer" className="whatsapp-float" title="Chat on WhatsApp">
